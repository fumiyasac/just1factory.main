    ...
    <div className="container">
      <div className="message_block">
        ...
        <p>
          ...
          <br />
          iOS アプリの UI 実装から始まり、バックエンド、React Native、Android、GraphQL、Flutter、そして生成 AI との共存へと少しずつ歩みを広げてきました。単にコードが動くことよりも、「なぜそう設計・実装するのか」を自分の言葉で説明できることを大切にしてきた 13 年間の軌跡を、
          <strong>年別・全 176 本のアーカイブ</strong>
          としてまとめています。
          <br />
          それぞれの登壇資料・記事には興味の対象がわかるように<strong>7 つのカテゴリー</strong>を付けています。
        </p>
      </div>
    </div>
  );
