...
export const GISHOHAKU_ITEMS: DesignItem[] = [
  ...
  },
  {
    ...
    title: "技術書同人誌博覧会 #13",
    subtitle: "開催告知チラシ（2025 夏配布・裏面）",
    date: "2026 年 5 月 10 日（日）",
    venue: "大田区産業プラザ PiO 大展示ホール",
    description:
...
// 親方 Project 寄稿「チラシで伝えるものづくり」関連の制作物。
export const OYAKATA_ITEMS: DesignItem[] = [
  ...
  },
  {
    ...
    description:
      "同誌に作例として掲載した、遊び心のある IoT プロダクト紹介チラシ。悩み → 解決 → 構成部品 → 費用と誘導線を段階化し、技術要素（ESP32 / 電磁弁 / スマホアプリ）を一枚で伝わる形に。",
    url: "https://oyakata2024.booth.pm/",
  },
];
