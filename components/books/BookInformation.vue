        ...
        <b-col cols="9">
          ...
          <div class="container pt-3">
            <p>
              ...
              <span class="small">※1 現在は電子版のみ販売中です。</span>
              <span class="small">※2 Xcode11.3.1 &amp; Swift5.1にも対応しております。</span>
            </p>
          </div>
          <div class="container pt-3">
      ...
      <b-row class="pt-4">
        ...
        <b-col cols="9">
          ...
          <div class="container pt-3">
            ...
            <p>内容は少し趣向を変えて更にアプリのUIを一つ上のステージへ上げるためのテクニックやGithub等で公開されているOSSのUIライブラリを上手に活用するためのTipsを紹介しております。</p>
          </div>
          <div class="container text-center pt-2">
            <ul class="list-unstyled list-inline">
              <li class="list-inline-item">
